    ...
    , textEdit(nullptr)
{
    ...
    connect(ui->textToFind, SIGNAL(textChanged(QString)),
            this, SLOT(textToFindChanged()));
    connect(ui->textToFind, SIGNAL(textChanged(QString)),
            this, SLOT(validateRegExp(QString)));
    connect(ui->regexCheckBox, SIGNAL(toggled(bool)),
            this, SLOT(regexpSelected(bool)));
...
void FindReplaceForm::setTextEdit(QTextEdit *textEdit_)
{
    ...
    connect(textEdit, SIGNAL(copyAvailable(bool)),
            ui->replaceButton, SLOT(setEnabled(bool)));
    connect(textEdit, SIGNAL(copyAvailable(bool)),
            ui->replaceAllButton, SLOT(setEnabled(bool)));
}
...
void FindReplaceForm::validateRegExp(const QString &text)
{
    ...
    QRegExp reg(text, (ui->caseCheckBox->isChecked() ?
